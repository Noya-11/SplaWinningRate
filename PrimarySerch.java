 ...
 */
@WebServlet(name = "PrimarySerch", urlPatterns = {"/PrimarySerch"})
public class PrimarySerch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int id = Integer.parseInt(request.getParameter("data_id"));
           ...
           // try{
            ...
            //id検索する
            String sql00 = "select * from SPR_DATA00 where data_id ="+id;
            ...
            rs.close();
            out.println("<hr>");
            out.println("<a href='/ap4_www/finalProject/managePage.html'>管理ページへ</a><br>");
