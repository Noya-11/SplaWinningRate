 ...
 * @author noya
 */
@WebServlet(name = "StageRecorde", urlPatterns = {"/StageRecorde"})
public class StageRecorde extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (rs01.next()) {
                ...
                out.println("<tr><td>勝敗</td><td>" + VorDstr + "</td></tr>");
                out.println("</table>");
                out.println("</p>");
                out.println("<hr>");
            ...
            out.println("<form name=\"userName引き継ぎ\" action=\"/SplatoonRecorde/webPage/RecordePage.jsp\" method=\"POST\">");
